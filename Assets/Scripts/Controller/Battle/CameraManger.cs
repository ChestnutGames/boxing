...
public class CameraManger : MonoBehaviour {
    ...
    public void Resolution()
    {
        ...
        float z = 80.0f * (1 - (a - 1.0f));
        Vector3 vec = initPos.transform.localPosition;
        vec.z = -300 - z;
        initPos.transform.localPosition = vec;
    }
	...
	void Update () {
        ...
        { 
            //Y
            Vector3 vecy = camera.transform.localPosition;
            //摄像机y轴运动方向
            ...
            if (negativeY == MoveNegative.MIN)
            {
                ...
                { 
                    vecy.y = moveTarY;
                    camera.transform.localPosition = vecy;   
                }
                else
                {
                    camera.transform.localPosition = vecy;
